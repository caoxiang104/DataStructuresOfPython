from Chapter12_Graphs.linkeddirectedgraph import LinkedDirectedGraph
...
class GraphDemoModel(object):
    ...
    def createGraph(self, rep, startLabel):
        """Create a graph from rep and startLabel.
        Returns a message if the graph was successfully created or
    ...
    def run(self, algorithm):
        """Runs the given algorithm on the graph and returns its result, or None
