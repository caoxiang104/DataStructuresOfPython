from Chapter12_Graphs.graphdemomodel import GraphDemoModel
from Chapter12_Graphs.algorithms import shortestPaths, spanTree, topoSort
...
class GraphDemoView(object):
    ...
    def _getFromFile(self):
        """Input a description of the graph from a file and creates the graph."""
        # Exercise
